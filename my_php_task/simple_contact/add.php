...
<body> 
    ...
    ?>
             ...
             <font color="#FF0000"><b>The Username " <?php echo $_POST['username']; ?>" is already in use, please choose another!</b></font>
              ...
              <?php 
                    echo "Your add is complete! " . "You are being sent to the page you requested!<br>";
    ...
    ?>
           ...
           <p> Welcome to the Add page!<br>
               All are required!
               
              <form action="add.php" method="post">
                       Username: <input type="text" name="username"><br> 
                       Password: <input type="password" name="password"><br> 
                       First Name: <input type="text" class="txtName" name="first_name"><br>
                       Last Name: <input type="text" class="txtName" name="last_name"><br>
                      Middle Name: <input type="text" class="txtName" name="middle_name"><br>
                      Organization: <input type="text" name="organization" ><br>
                      Position: <input type="text" name="position" ><br>
                      Email: <input type="text" name="email" ><br>
                      Phonenumber: <input type="text" class="only-numeric" name="phone_number" ><br>
                       <div class="error" style="color: red; display: none">* Input digits (0 - 9)</div><br>
                      Access method &nbsp;&nbsp;&nbsp;&nbsp; <select name="access">
